...
/* ---------------------- SSD1306 configuration for your board ---------------------- */

/* Use SPI (ustawiamy wersję SPI) */
...
/* If your display needs an X offset, ustaw na 0 (zwykle 0 dla SSD1306 128x64) */
#define SSD1306_X_OFFSET_LOWER 0x00
#define SSD1306_X_OFFSET_UPPER 0x00

/* Map the pins to STM32 pins (zgodnie z Twoim wiringiem) */
...
/* SPI handle name (CubeMX wygeneruje 'hspi1' jeśli używasz SPI1) */
